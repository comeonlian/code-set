package com.leolian.code.fragment.book.distributed.chapter02.solr;
...
public class InsertProgarm {
	...
	// solrhome下的core
	public static final String SOLR_CROE_HOME = "my_solr";
	// 待索引、查询字段
	...
	public static SolrClient getSolrClient() {
		return new HttpSolrClient(SOLR_SERVER_URL + "/" + SOLR_CROE_HOME);
	}
